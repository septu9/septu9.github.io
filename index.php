	...
	<div class="menu-area">
			<div id="dl-menu" class="dl-menuwrapper">
						...
						<ul class="dl-menu">
							...
							<li><a href="#penerimaan">Daftar Pegawai</a></li>
			...
			<div class="intro-text">
				<div class="container">
					...
					<div class="col-md-12">
						...
						<div class="brand">
							<img src='img/jb.jpg' width="350" height="200" >
							<h1><a href="index.html">HALAMAN UTAMA<br></a></h1>
							
							<p><span>WE ARE A GREAT TEAM</span></p>
							<?php
								if(isset($_SESSION['user'])){
							?>
			  ...
			  <div class="row">
				  <div class="col-md-offset-2 col-md-8">
					<div class="section-heading">
					 <h2>About us</h2>
					 <p> Kami telah berdiri sejak tahun 2016 dan sekarang ingin berlari</p>
					</div>
				  </div>
			  </div>
			  <div class="row">
                <div class="col-md-offset-2 col-md-8">
                    ...
                    <img src="img/team/rsudjb.jpg" width="250" height="200"/>
                    <h4>Rumah Sakit Umum Daerah Johar Baru merupakan rumah sakit pemerintah tipe D sesuai Keputusan Gubernur Nomor 1024 Tahun 2014 dengan kapasitas 29 tempat tidur yang awal mula berdiri pada tanggal 1 April 2015. Rumah sakit ini merupakan pelimpahan yang dulunya adalah Puskesmas Kecamatan Johar Baru yang beralamat di Jl. Tanah Tinggi XII Kelurahan Tanah Tinggi Kecamatan Johar Baru Jakarta Pusat.</h4>
                    <p></p>
					</div>
                </div>
			  </div>			  
	 ...
	 <section id="penerimaan" class="home-section bg-white">
		<div class="container">
			  <div class="row">
				  <div class="col-md-offset-2 col-md-8">
					<div class="section-heading">
					 <h2>DATA PEGAWAI RSUD JOHAR BARU</h2>
					 <p>Sistem Pendataan Pegawai RSUD JOHAR BARU</p>
					</div>
					...
					<?php
						$get= $user->GetData("where tempat_lahir='jakarta'");
						$no = 1;
						while($row = $get->fetch()){
							echo "<tr>
								<td>$no</td>
								...
								<td><a href='#' class='show_rincian' data-id='$row[nama_lengkap]' data-wow-delay='1s' data-toggle='modal' data-target='#myModalSyarat'>profile</a></td>
								</tr>";
						}
					?>
					</table>
...
<div class="modal fade" id="myModalSyarat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				<h4 class="modal-title" id="myModalLabel">Profile Pegawai</h4>
			</div>
